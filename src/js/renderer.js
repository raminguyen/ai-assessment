...
function displayResponseText(elements, item) {
    ...
    if ((['7','8','9','10','11','12'].includes(window.PROMPT_NUMBER)) && item.data.step1_result) {
        ...
        var isTune = item.command === 'tune';
        var step2PromptLabel = isTune ? 'Step 2: Tune Prompt' : 'Step 2: Generate Prompt';
        var step2ResultLabel = isTune ? 'Step 2: Tuned Essay' : 'Step 2: Final Essay';
        ...
        elements.responseContent.innerHTML =
            '<div style="display:flex; gap:1rem; margin-bottom:1rem;">' +
                ...
                '</div>' +
                '<div style="flex:1; min-width:0;">' +
                    '<h4 style="color:#27ae60; margin-bottom:0.5rem;">' + step2PromptLabel + '</h4>' +
            ...
            '<div style="display:flex; gap:1rem;">' +
                ...
                '</div>' +
                '<div style="flex:1; min-width:0;">' +
                    '<h4 style="color:#27ae60; margin-bottom:0.5rem;">' + step2ResultLabel + '</h4>' +
